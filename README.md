...
- **Процессы:** реинжиниринг, стандартизация, бережливое производство и DMAIC (Six Sigma).
- **Автоматизация:** RPA, макросы, отчётность, электронный документооборот.
- **Интеграции и ИИ:** сайты, CRM, почта, таблицы и мессенджеры; обработка обращений и извлечение данных.
- **Веб-решения:** сайты, чат-боты, CRM и сервисы онлайн-записи.

Описываю процессы в BPMN, ставлю ТЗ разработке и принимаю доработки. Веб-разработку и инфраструктуру осваиваю сейчас — CROND мой первый собственный проект и одновременно площадка для практики.
...
`Битрикс24` · `amoCRM` · `Мегаплан` · `YCLIENTS` · `Dikidi` · `Excel / VBA` · `RPA` · `BPMN` · `Lean` · `DMAIC`
